...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioRaiseVolume",
          function ()
              awful.spawn.with_shell("amixer -q sset Master 5%+") end,
    ...
    awful.key({ }, "XF86AudioMute",
          function ()
              awful.spawn.with_shell("amixer -q sset Master toggle") end,
...
awful.spawn.with_shell("feh --no-fehbg --bg-fill '/home/neuron/Yandex.Disk/morning-light1600x1200.jpg'")
awful.spawn.with_shell("lxpolkit")
awful.spawn.with_shell("nm-applet")
awful.spawn.with_shell("blueman-applet")
awful.spawn.with_shell("xfce4-power-manager")
awful.spawn.with_shell("xautolock -detectsleep -time 3 -locker \"i3lock-fancy -p\" -notify 30 -notifier \"notify-send -t 10000 -- 'LOCKING screen in 30 seconds'\"")
-- }}}
